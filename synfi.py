...
if __name__ == "__main__":
    ...
    parser.add_argument("--source-image", "-si", type=str, default="", help="File to use to initialize optimization")
    parser.add_argument("--weights", "-w", type=int, nargs='+', default=None, help="weights of different layers")
    ...
    if args.source_image:
        x0 = gram.preprocess(load_img(args.source_image))
        
    if args.weights == None:
        weights = np.ones(args.octaves*len(args.layers))
    else:
